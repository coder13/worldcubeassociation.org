...
export default buildConfig({
  ...
  collections: [
    withCmsCollectionAccess(Media),
    withCmsCollectionAccess(Testimonials),
    withCmsCollectionAccess(Announcements),
    withCmsCollectionAccess(FaqCategories),
    withCmsCollectionAccess(FaqQuestions),
    Users,
    withCmsCollectionAccess(Documents),
    withCmsCollectionAccess(RegulationsHistoryItem),
    withCmsCollectionAccess(Tools),
  ],
  globals: [
    withCmsGlobalAccess(Nav),
    withCmsGlobalAccess(Footer),
    withCmsGlobalAccess(SocialLinks),
    withCmsGlobalAccess(Home),
    withCmsGlobalAccess(AboutUsPage),
    withCmsGlobalAccess(Privacy),
    withCmsGlobalAccess(Disclaimer),
    withCmsGlobalAccess(SpeedCubingHistoryPage),
    withCmsGlobalAccess(AboutRegulations),
    withCmsGlobalAccess(DocumentsPage),
    withCmsGlobalAccess(FaqPage),
    withCmsGlobalAccess(LogoPage),
  ],
